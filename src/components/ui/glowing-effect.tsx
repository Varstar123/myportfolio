...
/**
 * A brand-coloured conic glow that traces the card's border and rotates toward
 * the cursor as it approaches. Faithful to Aceternity's GlowingEffect, themed
 * to the site's indigo / cyan / violet palette.
 */
          ...
          style={
            {
              ...
              "--gradient":
                ...
                repeating-conic-gradient(
                  from 236.84deg at 50% 50%,
                  #818cf8 0%,
                  #22d3ee calc(25% / var(--repeating-conic-gradient-times)),
